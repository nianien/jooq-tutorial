...
public class UserInfoConfigRecord extends UpdatableRecordImpl<UserInfoConfigRecord> implements Record9<Long, Long, Long, Long, Long, Date, Date, Long, String> {
    ...
    @Override
    public Row9<Long, Long, Long, Long, Long, Date, Date, Long, String> valuesRow() {
    ...
    public Field<String> field9() {
        return UserInfoConfig.USER_INFO_CONFIG.ENV;
    }
    ...
    @Override
    public UserInfoConfigRecord value9(String value) {
        setEnv(value);
        return this;
    }

    @Override
    public UserInfoConfigRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Date value6, Date value7, Long value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserInfoConfigRecord(Long id, Long userid, Long priority, Long maxVersion, Long minVersion, Date createTime, Date modifyTime, Long auditorId, String env) {
        super(UserInfoConfig.USER_INFO_CONFIG);

...
public class WordPackageDetail implements Serializable {
    ...
    public WordPackageDetail(WordPackageDetail value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("WordPackageDetail (");

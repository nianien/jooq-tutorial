...
public class AuditBlacklistWord implements Serializable {
    ...
    public AuditBlacklistWord(AuditBlacklistWord value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("AuditBlacklistWord (");

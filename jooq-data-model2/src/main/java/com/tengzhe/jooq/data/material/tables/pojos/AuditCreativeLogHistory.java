...
public class AuditCreativeLogHistory implements Serializable {
    ...
    public AuditCreativeLogHistory(AuditCreativeLogHistory value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("AuditCreativeLogHistory (");

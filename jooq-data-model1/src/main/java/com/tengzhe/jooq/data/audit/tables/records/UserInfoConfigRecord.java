...
public class UserInfoConfigRecord extends UpdatableRecordImpl<UserInfoConfigRecord> implements Record8<Long, Long, Long, Long, Long, LocalDateTime, LocalDateTime, Long> {
    ...
    @Override
    public UserInfoConfigRecord value6(LocalDateTime value) {
        setCreateTime(value);
        return this;
    }

    @Override
    public UserInfoConfigRecord value7(LocalDateTime value) {
        setModifyTime(value);
        return this;
    }
    ...
    @Override
    public UserInfoConfigRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, LocalDateTime value6, LocalDateTime value7, Long value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserInfoConfigRecord(Long id, Long userid, Long priority, Long maxVersion, Long minVersion, LocalDateTime createTime, LocalDateTime modifyTime, Long auditorId) {
        super(UserInfoConfig.USER_INFO_CONFIG);
     ...
     * Create a detached, initialised UserInfoConfigRecord
     */
    public UserInfoConfigRecord(com.tengzhe.jooq.data.audit.tables.pojos.UserInfoConfig value) {
        super(UserInfoConfig.USER_INFO_CONFIG);

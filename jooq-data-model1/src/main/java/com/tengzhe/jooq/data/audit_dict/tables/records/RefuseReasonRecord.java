...
public class RefuseReasonRecord extends UpdatableRecordImpl<RefuseReasonRecord> implements Record12<Integer, String, String, String, Integer, Integer, Integer, Integer, Integer, Integer, Integer, LocalDateTime> {
    ...
    @Override
    public Row12<Integer, String, String, String, Integer, Integer, Integer, Integer, Integer, Integer, Integer, LocalDateTime> fieldsRow() {
        return (Row12) super.fieldsRow();
    }

    @Override
    public Row12<Integer, String, String, String, Integer, Integer, Integer, Integer, Integer, Integer, Integer, LocalDateTime> valuesRow() {
    ...
    @Override
    public RefuseReasonRecord value12(LocalDateTime value) {
        setCreateTime(value);
        return this;
    }

    @Override
    public RefuseReasonRecord values(Integer value1, String value2, String value3, String value4, Integer value5, Integer value6, Integer value7, Integer value8, Integer value9, Integer value10, Integer value11, LocalDateTime value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RefuseReasonRecord(Integer id, String code, String reason, String reasonDetail, Integer auditType, Integer orderId, Integer appId, Integer additionable, Integer level, Integer parentId, Integer showStatus, LocalDateTime createTime) {
        super(RefuseReason.REFUSE_REASON);
     ...
     * Create a detached, initialised RefuseReasonRecord
     */
    public RefuseReasonRecord(com.tengzhe.jooq.data.audit_dict.tables.pojos.RefuseReason value) {
        super(RefuseReason.REFUSE_REASON);

...
public class AuditTypeRiskTagConfig extends TableImpl<AuditTypeRiskTagConfigRecord> {
     ...
     */
    public final TableField<AuditTypeRiskTagConfigRecord, LocalDateTime> CREATE_TIME = createField(DSL.name("create_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column
     * <code>audit_dict.audit_type_risk_tag_config.modify_time</code>.
     */
    public final TableField<AuditTypeRiskTagConfigRecord, LocalDateTime> MODIFY_TIME = createField(DSL.name("modify_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

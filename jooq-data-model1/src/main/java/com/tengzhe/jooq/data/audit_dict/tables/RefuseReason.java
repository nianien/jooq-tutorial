...
public class RefuseReason extends TableImpl<RefuseReasonRecord> {
     ...
     */
    public final TableField<RefuseReasonRecord, LocalDateTime> CREATE_TIME = createField(DSL.name("create_time"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

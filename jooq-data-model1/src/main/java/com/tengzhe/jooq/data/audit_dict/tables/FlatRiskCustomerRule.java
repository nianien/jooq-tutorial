...
public class FlatRiskCustomerRule extends TableImpl<FlatRiskCustomerRuleRecord> {
     ...
     */
    public final TableField<FlatRiskCustomerRuleRecord, LocalDateTime> NEXT_PROCESS_TIME = createField(DSL.name("next_process_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>audit_dict.flat_risk_customer_rule.create_time</code>.
     */
    public final TableField<FlatRiskCustomerRuleRecord, LocalDateTime> CREATE_TIME = createField(DSL.name("create_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>audit_dict.flat_risk_customer_rule.modify_time</code>.
     */
    public final TableField<FlatRiskCustomerRuleRecord, LocalDateTime> MODIFY_TIME = createField(DSL.name("modify_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

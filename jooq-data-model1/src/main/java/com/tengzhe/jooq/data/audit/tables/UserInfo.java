...
public class UserInfo extends TableImpl<UserInfoRecord> {
     ...
     */
    public final TableField<UserInfoRecord, LocalDateTime> VERSION = createField(DSL.name("version"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("'2010-01-01 00:00:00'", SQLDataType.LOCALDATETIME)), this, "");
     ...
     */
    public final TableField<UserInfoRecord, String> TELEPHONE = createField(DSL.name("telephone"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>audit.user_info.create_time</code>.
     */
    public final TableField<UserInfoRecord, LocalDateTime> CREATE_TIME = createField(DSL.name("create_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("'1980-01-01 00:00:00'", SQLDataType.LOCALDATETIME)), this, "");
     ...
     */
    public final TableField<UserInfoRecord, LocalDateTime> MODIFY_TIME = createField(DSL.name("modify_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>audit.user_info.audit_start_time</code>.
     */
    public final TableField<UserInfoRecord, LocalDateTime> AUDIT_START_TIME = createField(DSL.name("audit_start_time"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field("NULL", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>audit.user_info.audit_end_time</code>.
     */
    public final TableField<UserInfoRecord, LocalDateTime> AUDIT_END_TIME = createField(DSL.name("audit_end_time"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field("NULL", SQLDataType.LOCALDATETIME)), this, "");

...
public class RiskCustomerRule extends TableImpl<RiskCustomerRuleRecord> {
     ...
     */
    public final TableField<RiskCustomerRuleRecord, LocalDateTime> OPERATE_TIME = createField(DSL.name("operate_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>audit_dict.risk_customer_rule.create_time</code>.
     */
    public final TableField<RiskCustomerRuleRecord, LocalDateTime> CREATE_TIME = createField(DSL.name("create_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>audit_dict.risk_customer_rule.modify_time</code>.
     */
    public final TableField<RiskCustomerRuleRecord, LocalDateTime> MODIFY_TIME = createField(DSL.name("modify_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

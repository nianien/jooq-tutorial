...
public class AccountRecord extends UpdatableRecordImpl<AccountRecord> implements Record20<Long, String, Long, String, Integer, Integer, String, String, Integer, String, String, String, Long, Long, Long, Integer, Long, Long, Date, Date> {
    ...
    @Override
    public Row20<Long, String, Long, String, Integer, Integer, String, String, Integer, String, String, String, Long, Long, Long, Integer, Long, Long, Date, Date> valuesRow() {
     ...
     */
    public AccountRecord(Long id, String name, Long userId, String shortName, Integer appId, Integer createSource, String productName, String webSite, Integer licenseType, String contact, String phone, String email, Long corpId, Long signCorpId, Long adCorpId, Integer status, Long agentId, Long shopUserId, Date createTime, Date updateTime) {
        super(Account.ACCOUNT);
